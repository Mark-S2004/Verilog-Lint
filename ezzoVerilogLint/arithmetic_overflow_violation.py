...
my_dict={}
variableline={}
with open(r'Verilog-Lint/ezzoVerilogLint/tests/verilog_samples/mini_verilog_sample.v', "r") as verilog_file:
    ...
    for match in overflow_matches:
        ...
        if var in variable_bits:
            ...
            if max_value_operands is not None and abs(max_value_operands) > max_value:
                lines = verilog.count('\n', 0, match.start()) + 1
                print(f"Arithmetic overflow detected in variable {var} at line {lines}.")
detect_arithmetic_overflow(verilog)